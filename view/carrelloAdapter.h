...
#ifndef CARRELLOADAPTER_H
#define CARRELLOADAPTER_H

#include <QAbstractTableModel>
#include<model/model.h>

class carrelloAdapter : public QAbstractTableModel
{
    Q_OBJECT
...
public:
    ...
    enum Role {
        ...
        carrelloAdapter(QObject *parent = nullptr, Model* = 0);
