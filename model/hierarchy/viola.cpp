...
Viola::Viola(double _price, const std::string& _brand, const std::string& _model, const std::string& _desc, Strumento::Tune _key, bool _used, unsigned int _quantity, const std::string& _path):
     Strumento(_price ,_brand, _used, _desc, _quantity, _model, _path), Arco(_brand == Strumento::lutherie), key(_key){}
